...
exports.createTables = async() => {
	...
	//Run tables queries
	for(let key of Object.keys(sql.tables)) await helpers.arrayOfQueries(sql.tables[key], connection);
	
	//Run constraint queries
	for(let key of Object.keys(sql.constraints)) await helpers.arrayOfQueries(sql.constraints[key], connection);
